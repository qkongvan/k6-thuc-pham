...
/**
 * This is the model class for table "live_items".
 *
 * The followings are the available columns in table 'live_items':
 * @property string $id
 ...
 */
class LiveItem extends HActiveRecord
{
	public $categories;
	// Set default value
	public $status = 1;
	 ...
	 * @return LiveItem the static model class
	 */
	...
	public function relations()
	{
		...
		return array('categoryitem' => array(self::HAS_MANY, 'LiveCategoryItem', 'item_id'), );
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array('criteria' => $criteria, 'pagination' => array('pageSize' => Yii::app()->getModule('live')->entriesManageShow, ), ));
	}
