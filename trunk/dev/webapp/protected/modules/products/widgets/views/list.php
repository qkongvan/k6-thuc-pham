...
<div class="h-module-products-entries">
	...
	<?php foreach($data as $item) : ?>
		<li>
			...
			<a href="<?php echo $url; ?>"><img width="120" height="100" title="<?php echo CHtml::encode($item->name); ?>" rel="<?php echo $item->id.'|||'.$item->price; ?>" alt="" src="<?php if ($item->image) { echo Yii::app()->createAbsoluteUrl('/') . '/files/products/thumb_' . $item->image; } else { echo $baseScriptUrl . '/no_image.gif'; } ?>" /></a>
