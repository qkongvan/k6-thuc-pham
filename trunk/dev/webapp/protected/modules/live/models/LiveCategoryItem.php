 ...
 */
class LiveCategoryItem extends HActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'category' => array(self::BELONGS_TO, 'LiveCategory', 'category_id'),
			'item' => array(self::BELONGS_TO, 'LiveItem', 'item_id'),
		);
	}
